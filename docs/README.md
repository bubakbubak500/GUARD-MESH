...
- [Původní instalace na Tanmatsu](UPSTREAM-TANMATSU.md)

Upstream návody jsou pouze textový převod, bez obrázků. Popisují původní
WadaMesh a jeho služby; vlastní dokumentace Guardianu vznikne s dalšími změnami.
Podporované desky jsou v [DEVICES.md](../DEVICES.md).
